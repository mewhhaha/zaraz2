...
export const OpenModal = ({
  ...
  return (
    <div
      class={cx(
        `
          absolute top-0 -right-6 flex max-h-[80dvh] min-h-0 w-lg max-w-[97dvw]
          translate-y-4 flex-col drop-shadow-sm/100
    ...
    >
      ...
      <div
        class={`
          absolute top-0 right-3 size-3 -translate-1.25 -translate-x-1/2
          rotate-45 border-t-2 border-l-2 border-gray-700 bg-slate-950
        `}
      ></div>
      <div
        class={`
          flex size-full flex-col overflow-hidden rounded-lg border-2
          border-gray-700 bg-slate-950 p-2 text-gray-100
          sm:p-6
        `}
      >
        {children}
