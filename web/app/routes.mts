...
import * as $auth_forgotten from "./routes/auth.forgotten/route.tsx";
...
const $$auth_forgotten = { id: "auth.forgotten", mod: $auth_forgotten };
...
export const routes: route[] = [[/^\/auth\/forgotten\/(?<id>[^/]+)$/, [$document,$$auth_forgotten,$$auth_forgotten__id]],
