...
import * as $_root_tasks___id_ from "./routes/_root.tasks.($id).tsx";
import * as $_root_tasks from "./routes/_root.tasks.tsx";
import * as $_root from "./routes/_root.tsx";
const $$_root_tasks___id_ = { id: "_root.tasks.($id)", mod: $_root_tasks___id_, params: ["id"] };
...
export const routes: route[] = [[/^tasks(?:\/(?<id>[^/]+))?$/, [$document,$$_root,$$_root_tasks,$$_root_tasks___id_]],
