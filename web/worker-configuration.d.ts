/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6baada5c549c355f46095ddaa776f87)
// Runtime types generated with workerd@1.20251011.0 2025-06-15 nodejs_als
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    ORIGIN: "https://zaraz2.app";
    DEMO: string;
    SECRET_KEY: string;
    OBJECT_USER: DurableObjectNamespace<
      import("./worker/main").DurableObjectUser
    >;
    OBJECT_PASSKEY: DurableObjectNamespace<
      import("./worker/main").DurableObjectPasskey
    >;
    OBJECT_CHALLENGE: DurableObjectNamespace<
      import("./worker/main").DurableObjectChallenge
    >;
    ASSETS: Fetcher;
  }
}
